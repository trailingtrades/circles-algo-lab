...
const S = {
  ...
  intro: t3("Slides, handouts and templates for your stage. Files open in a new tab.", "Aapke stage ki slides, handouts aur templates. Files naye tab mein khulti hain.", "आपके स्टेज की स्लाइड्स, हैंडआउट और टेम्पलेट। फ़ाइलें नए टैब में खुलती हैं।"),
  ...
  empty: t3("Files for this stage will appear here.", "Is stage ki files yahan dikhengi.", "इस स्टेज की फ़ाइलें यहाँ दिखेंगी।"),
  ...
  workbookNote: t3("Exercises for the whole stage, to print or work through at your own pace.", "Poore stage ki exercises, print karke ya apni speed se karne ke liye.", "पूरे स्टेज के अभ्यास, प्रिंट करके या अपनी रफ़्तार से करने के लिए।"),

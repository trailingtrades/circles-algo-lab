...
export function SessionEditor({ s }: { s: S }) {
  ...
  return (
    <form ref={ref} onSubmit={onSubmit} className="mt-3">
      ...
      <JsonArea id="ct" name="content" label="Lesson content (JSON, v2)" value={s.content} rows={24} hint="topics, story, key_terms, mindmap, kaam, kaam_steps, artefacts, outcome, tools, fun, journal_prompt, motivation, tags. Every text is a string or {en, hi, dv}. Format: docs/SMART_CONTENT_SCHEMA.md. Scanned for compliance on save." />

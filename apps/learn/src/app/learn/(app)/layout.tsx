...
async function stageAccess(v: Viewer): Promise<{ funda: boolean; winners: boolean; winners_plus: boolean; one: boolean; pro_plus: boolean } | undefined> {
  if (v.role !== "student") return { funda: true, winners: true, winners_plus: true, one: true, pro_plus: true };
  ...
  return { funda: open("funda"), winners: open("winners"), winners_plus: open("winners_plus"), one: open("one"), pro_plus: open("pro_plus") };
}

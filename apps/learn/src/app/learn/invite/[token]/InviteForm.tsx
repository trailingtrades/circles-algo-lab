...
const CARDS = [
  { icon: Target, title: t3("We score your process", "Yahan process ka score hota hai", "यहाँ प्रोसेस का स्कोर होता है"), body: t3("Your score comes from quizzes, your journal and the Friday review. The mock portfolio's return never counts, because a return can be luck and a process cannot.", "Score quiz, journal aur Friday review se banta hai. Mock portfolio ka return kabhi count nahi hota, kyunki return kismat se bhi aa sakta hai, process nahi.", "स्कोर क्विज़, जर्नल और फ्राइडे रिव्यू से बनता है। मॉक पोर्टफ़ोलियो का रिटर्न कभी नहीं गिना जाता, क्योंकि रिटर्न किस्मत से भी आ सकता है, प्रोसेस नहीं।") },

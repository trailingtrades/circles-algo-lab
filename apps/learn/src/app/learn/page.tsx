...
const S = {
  ...
  kicker2p: t3("Stage 2+ · 5 Circles Academy", "Stage 2+ · 5 Circles Academy", "चरण 2+ · 5 Circles Academy"),
...
export default async function LoginPage({ searchParams }: { searchParams: Promise<SP> }) {
  ...
  const title = stage === "winners" ? "CIRCLE W.I.N.N.E.R.S" : stage === "winners_plus" ? "CIRCLE W.I.N.N.E.R.S +" : stage === "one" ? "CIRCLE O.N.E" : stage === "stage0" ? "CIRCLE S.T.A.R.T" : stage === "pro_options" ? "CIRCLE PRO · Options 117" : "CIRCLE S.M.A.R.T";
  const kicker = stage === "winners" ? S.kicker2 : stage === "winners_plus" ? S.kicker2p : stage === "one" ? S.kicker3 : stage === "stage0" ? S.kicker0 : stage === "pro_options" ? S.kicker4 : S.kicker1;
  return (
    <div className="lrn-shell lrn-gate">
      <AcademyStrip current={stage === "winners" ? "winners" : stage === "winners_plus" ? "winners_plus" : stage === "one" ? "one" : stage === "stage0" ? "start" : "smart"} />
